    ...
    ui(new Ui::MainWindow)
{
    ...
    //Set operator, store number, and switch toggle flags to false
...
{
    //this command line swaps the symbols on the function to do advanced functions
    if(switchToggle == false){
        ui->actionDiv->setText("R");
        ui->actionMinus->setText("Log");
        ui->actionPlus->setText("M");
        ui->actionMul->setText("^");
        switchToggle = true;
    }
    else if (switchToggle == true){
        ui->actionMinus->setText("-");
        ui->actionMul->setText("*");
        ui->actionDiv->setText("/");
        ui->actionPlus->setText("+");
        switchToggle = false;
    }
    /*//Get string from display
    QString displayLabel = ui->displayPanel->text();
...
void MainWindow::calculate_result() {
    ...
    //these three are the advanced functions I added
    else if (storedOperator == '^'){
        double x;
    ...
    else if(storedOperator == 'R'){
        if(storedNumber > 0){
            storedNumber = qSqrt(displayLabel.toDouble());
        }
    }
    else if(storedOperator == 'M'){
        storedNumber = fmod(storedNumber,displayLabel.toDouble());
    }
